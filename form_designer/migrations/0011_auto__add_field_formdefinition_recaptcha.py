...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinition.recaptcha'
        db.add_column('form_designer_formdefinition', 'recaptcha',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormDefinition.recaptcha'
        db.delete_column('form_designer_formdefinition', 'recaptcha')
