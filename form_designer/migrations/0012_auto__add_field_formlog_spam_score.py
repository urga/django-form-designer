...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormLog.spam_score'
        db.add_column('form_designer_formlog', 'spam_score',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FormLog.spam_score'
        db.delete_column('form_designer_formlog', 'spam_score')
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'recaptcha': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'form_designer.formlog': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'spam_score': ('django.db.models.fields.FloatField', [], {'null': 'True'})
        },
