...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FormDefinition.honeypot_fieldname'
        db.add_column('form_designer_formdefinition', 'honeypot_fieldname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


        # Changing field 'FormValue.value'
        db.alter_column('form_designer_formvalue', 'value', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'FormDefinition.honeypot_fieldname'
        db.delete_column('form_designer_formdefinition', 'honeypot_fieldname')


        # Changing field 'FormValue.value'
        db.alter_column('form_designer_formvalue', 'value', self.gf('picklefield.fields.PickledObjectField')(null=True))
    ...
    models = {
        ...
        'form_designer.formdefinition': {
            ...
            'honeypot_fieldname': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
